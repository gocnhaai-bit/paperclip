      ...
      {data && (
        <>
          ...
          <section className="space-y-3" aria-labelledby="dashboard-trends-heading">
            ...
            {/* The widest tier drops to three columns when the priority chart is
                hidden, so the remaining charts still fill the row. */}
            <div className={cn(
              "grid grid-cols-1 gap-4 md:grid-cols-2",
              SHOW_TASK_PRIORITY_UI ? "xl:grid-cols-4" : "xl:grid-cols-3",
            )}>
